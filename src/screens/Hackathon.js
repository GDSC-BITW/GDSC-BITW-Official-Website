...
const HackathonScreen = () => {
    ...
    return (
        <>
            ...
            <Grid container className="aboutHackathon" justifyContent="center" alignItems="center" >
            ...
            <Grid container spacing={5} className="section-center">
                ...
                <Grid item className='desc domains' lg={3}>Disaster Managment</Grid>
                <Grid item className='desc domains' lg={3}>MedTech / BioTech / HealthTech</Grid>
                <Grid item className='desc domains' lg={3}>Blockchain & Cybersecurity</Grid>
                <Grid item className='desc domains' lg={3}>Smart Vehicles</Grid>
                <Grid item className='desc domains' lg={3}>Smart Automation</Grid>
                <Grid item className='desc domains' lg={3}>Smart Education</Grid>
                <Grid item className='desc domains' lg={3}>Transportation & Logistics</Grid>
                <Grid item className='desc domains' lg={3}>Heritage & Culture</Grid>
                <Grid item className='desc domains' lg={3}>Agriculture, FoodTech & Rural
                    Development</Grid>
            ...
            <Grid container spacing={5} className="section-center" style={{ marginLeft: '-30px' }} >
                <Grid lg={12} style={{ margin: '50px 0px' }} >
                    <p className='center'>
